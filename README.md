...
In this project, we expanded on the last AirBnB project and added SQLALchmeny functionality to make sure class attribute IDs could be linked together.
...
Using this repo, the developer can either store their data in a file storage system or on a SQL database.
...
Files: `console.py, console.py, tests/`
...
[Marc Cavigli](https://github.com/MCavigli) - mcavigli@gmail.com